...
export const businessCustom: CustomCharacter = {
  ...
  onboarding: [
    ...
    },
    {
      ...
      text: 'John gets his Person credential from the BC Services Card app. He starts the process within BC Wallet. For this demo you will scan this QR code to receive the credential offer.',
      ...
      screens: [
        {
          ...
          text: 'John can get a business licence from the City of Vancouver using his Digital Business Card. They require proof that you’re a business owner in B.C. and a matching name to your digital business card.',
        ...
        },
        {
          screenId: 'STEP_END',
          title: "You're done!",
          text: 'You’ve proved to the City of Vancouver that you’re a business owner from B.C. and your identity using your Person credential. You can now start your new business with the busincess licence. It only took a few seconds and you revealed minimal information that the City of Vancouver could easily and automatically trust.',
