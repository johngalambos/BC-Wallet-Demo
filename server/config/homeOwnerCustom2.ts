...
export const homeOwnerCustom2: CustomCharacter = {
  name: 'Molly',
  type: 'Homeowner',
  image: '/public/contractor/contractor.svg',
  description:
    'Molly is a contractor. To work on a project she needs to verify her qualifications issued by Technical Safety B.C.',
  // revocationInfo: [
  //   {
  ...
  onboarding: [
    {
      ...
      title: 'Meet Molly',
      text: 'Molly is a contractor. To help verify her credentials quicker, Technical Safety B.C. is going to offer Molly a Trade Qualifications Card to put in her BC Wallet.',
    },
    {
    ...
    },
    {
      ...
      text: 'Molly gets her Person credential from the BC Services Card app. she starts the process within BC Wallet. For this demo you will scan this QR code to receive the credential offer.',
    ...
    {
      screenId: 'CONNECT_LTSA',
      title: 'Get Homeowner credential',
      text: 'Molly gets her Homeowner credential from the BC Services Card app. she starts the process within BC Wallet. For this demo you will scan this QR code to receive the credential offer.',
      image: '/public/lawyer2/onboarding/personCredPhone.svg',
      issuer_name: 'LTSA',
    },
    {
      screenId: 'ACCEPT_LTSA',
      title: 'Accept your Homeowner credential',
      text: 'Check your phone. You’ve received a credential offer from Service BC in your BC Wallet. You can use this credential to prove who you are online.',
      image: '/public/lawyer2/onboarding/personCredPhone.svg',
      credentials: [
        {
          name: 'new_homeowner_cred',
          version: '1.0.0',
          icon: '/public/lawyer2/connection/bc-logo.png',
          attributes: [
            {
      ...
      screens: [
        {
          ...
          text: 'Molly can apply for a Digital Letter of Authorization from the City of Vancouver and using her Person Credential and HomeOwner Credential.',
